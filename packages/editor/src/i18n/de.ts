...
export const de: EditorTranslations = {
  ...
  editor: {
    dropHint:
      'Feld aus der Palette hierher ziehen, um das Formular zu beginnen.',
    dropHere: 'hier ablegen',
    ablegen: 'ablegen',
    spalte: 'Spalte',
    feldHierher: 'Feld hierher ziehen',
  ...
  dialog: {
    ...
    uiSchemaTab: 'UI Schema (JSONForms)',
    importTab: 'Import',
    importHint:
      'JSON-Datei hochladen mit schema und uiSchema. Das aktuelle Formular wird überschrieben.',
