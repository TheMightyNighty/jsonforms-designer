...
export const en: EditorTranslations = {
  ...
  properties: {
    ...
    options: 'Options',
    validatoren: 'OpenCode validators',
    textElement: 'Text element',
    gruppe: 'Group',
    spaltenLayout: 'Column layout',
  ...
  dialog: {
    ...
    importTab: 'Import',
    importHint:
      'Upload a JSON file with schema and uiSchema. The current form will be overwritten.',
